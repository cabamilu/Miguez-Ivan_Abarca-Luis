...
public class DomicilioTurnoEntradaDto {
    @NotNull(message = "Debe proveerse el id del domicilio")
    private Long id;
    ...
    public DomicilioTurnoEntradaDto() {
    }
    public DomicilioTurnoEntradaDto(Long id, String calle, Integer numero, String localidad, String provincia) {
        this.id = id;
        this.calle = calle;
        this.numero = numero;
