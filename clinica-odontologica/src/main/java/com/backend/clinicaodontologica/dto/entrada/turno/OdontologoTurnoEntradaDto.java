...
public class OdontologoTurnoEntradaDto {
    @NotNull(message = "Debe proveerse el id del odontologo para el turno a registrar")
    private Long id;
    ...
    public OdontologoTurnoEntradaDto() {
    }
    public OdontologoTurnoEntradaDto(Long id, int numeroMatricula, String nombre, String apellido) {
        this.id = id;
